            ...
            <div className="ep-hero-wrapper">
                ...
                <div className="ep-hero-content">
                    ...
                    <div className="ep-hero">
                        ...
                        {/* Glassmorphism card — same style as About Us */}
                        <div className="ep-title-card">
                            <h1 className="ep-page-title">Our Events</h1>
                            <div className="ep-title-line"></div>
                        </div>
                    </div>
                </div>
            </div>

            {/* ── Subtitle below circuit ── */}
            <div className="ep-subtitle-wrap">
